# -*- coding: utf-8 -*-
"""Copy of Estadística.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1aP7i2ReMvl9NBcWEh8VD7v83iY-q92zZ
"""
...
# Correlación entre columnas (primera y segunda columna)
...
# Generando los datos
altura = np.random.normal(loc=1.65, scale=0.1, size=100)  # Altura en metros
cintura = np.random.normal(loc=80, scale=10, size=100)  # Cintura en cm

# Crear el array de NumPy 2D
datos_mexico = np.column_stack((altura, cintura))
...
plt.subplot(1, 2, 1)  # Subgráfico 1 (1 fila, 2 columnas, gráfico 1)
plt.hist(altura, bins=15, color='skyblue', edgecolor='black')
plt.title('Histograma de Altura')
plt.xlabel('Altura (m)')
plt.ylabel('Frecuencia')

# Histograma de cintura
plt.subplot(1, 2, 2)  # Subgráfico 2 (1 fila, 2 columnas, gráfico 2)
plt.hist(cintura, bins=15, color='lightcoral', edgecolor='black')
